...
//        ICollection<MvcControllerViewModel> GetAllControllerActionsWithAttribute(Type att);
...
//        private readonly ConcurrentDictionary<string, Lazy<ICollection<MvcControllerViewModel>>> _allActions =
...
//        public ICollection<MvcControllerViewModel> GetAllControllerActionsWithAttribute(Type att)

//        {
//            //var getter = _allSecuredActionsWithPloicy.GetOrAdd(policyName, y => new Lazy<ICollection<MvcControllerViewModel>>
//            var getter = _allActions.GetOrAdd("", y => new Lazy<ICollection<MvcControllerViewModel>>
//            (
//                () =>
//                {
//                    var controllers = new List<MvcControllerViewModel>(MvcControllers);
//                    var IsCustome = new List<MvcControllerViewModel>(MvcControllers);
//                    foreach (var controller in controllers)
//                    {
//                            // 1- for static type
//                            //if (!controller.ControllerAttributes.Any(x => x.TypeId.Equals(typeof(ClaimRequirementAttribute))))
//                            // 2- for dynamic type
//                            if (!controller.ControllerAttributes.Any(x => x.GetType() == att))

//                        {
//                            IsCustome.Remove(controller);
//                        }
//                    }
//                    return IsCustome.Where(model => model.MvcActions.Any()).ToList();
