...
namespace PermissionParts
{
    public class PermissionDisplay
    {
        ...
        public static List<PermissionDisplay> GetPermissionsToDisplay(Type enumType)
        {
            ...
            foreach (var permissionName in System.Enum.GetNames(enumType))
            {
                ...
                var permission = (Permissions)System.Enum.Parse(enumType, permissionName, false);
        ...
        public static PermissionDisplay GetPermissionToDisplay(Type enumType, string permissionName)
        {
            ...
            var result =new PermissionDisplay(displayAttribute.GroupName, displayAttribute.Name,
                            displayAttribute.Description, permission, moduleAttribute?.PaidForModule.ToString());
