...
namespace shop.ViewModels.Infrastructure
{
    /// <summary>
    /// خط 31 با توجه به پروژه عوض شود
    /// </summary>
    public static class AutoMapperConfiguration
    {
        ...
        {
            // اینجا
            var assembly = Assembly.Load("shop.ViewModels");

            //  var assembly = Assembly.GetAssembly(Type.GetType("KafshProject.ViewModels"));
            config.ConfigureAutoMapperForDto(
                assembly
