    ...
    public static class AddIdentityOptionsExtensions
    {
            ...
            this IServiceCollection services, SiteSettings siteSettings)
        {
            ...
            services.AddIdentity<User, Role>(identityOptions =>
            {
                ...
                setUserOptions(identityOptions.User, siteSettings);
        ...
        private static void setUserOptions(UserOptions identityOptionsUser, SiteSettings siteSettings)
        {
            identityOptionsUser.RequireUniqueEmail = siteSettings.RequireUniqueEmail;
        }
    }
}