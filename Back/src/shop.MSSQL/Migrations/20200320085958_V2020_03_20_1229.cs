...
{
    public partial class V2020_03_20_1229 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    natioalCode = table.Column<string>(maxLength: 10, nullable: true),
                    ...
                    WalletPrice = table.Column<int>(nullable: true),
                    Score = table.Column<int>(nullable: true),
                    IsActive = table.Column<bool>(nullable: false),
                    LastLoggedIn = table.Column<DateTime>(nullable: true),
                    SerialNumber = table.Column<string>(nullable: true),
                    FirstReserve = table.Column<bool>(nullable: false),
                    VerifyCode = table.Column<int>(nullable: true),
                    ExpireDateVerifyCode = table.Column<DateTime>(nullable: true),
                    IsRegister = table.Column<bool>(nullable: true),
                    IsRequestRestPassword = table.Column<bool>(nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TotalWithDiscountPrice = table.Column<int>(nullable: false),
                    ...
                    SenderMobile = table.Column<string>(nullable: true),
                    SenderName = table.Column<string>(nullable: true),
                    ReciverMobile = table.Column<string>(nullable: true),
                    ReciverName = table.Column<string>(nullable: true),
                    ReciverAddress = table.Column<string>(nullable: true),
                    OrderType = table.Column<int>(nullable: false),
                    OrderSendType = table.Column<int>(nullable: false),
                    UserId = table.Column<int>(nullable: false),
                    CreatedByBrowserName = table.Column<string>(maxLength: 1000, nullable: true),
                    CreatedByIp = table.Column<string>(maxLength: 255, nullable: true),
                    CreatedByUserId = table.Column<int>(nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OsType = table.Column<byte>(nullable: false),
                    CreatedByBrowserName = table.Column<string>(maxLength: 1000, nullable: true),
                    CreatedByIp = table.Column<string>(maxLength: 255, nullable: true),
                    CreatedByUserId = table.Column<int>(nullable: true),
                    CreatedDateTime = table.Column<DateTime>(nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_UserDevice_AppUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AppUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_GateWays_Orders_OrderId",
                        column: x => x.OrderId,
                        principalTable: "Orders",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_GateWays_AppUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AppUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ProductOptions_Fields_FieldId",
                        column: x => x.FieldId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OptionColors", x => x.Id);
                    table.ForeignKey(
                        name: "FK_OptionColors_ProductOptions_ProductOptionId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OptionColorId = table.Column<int>(nullable: true),
                    ProductId = table.Column<int>(nullable: false),
                    CreatedByBrowserName = table.Column<string>(maxLength: 1000, nullable: true),
                    CreatedByIp = table.Column<string>(maxLength: 255, nullable: true),
                    CreatedByUserId = table.Column<int>(nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_OrderProducts_OptionColors_OptionColorId",
                        column: x => x.OptionColorId,
                        principalTable: "OptionColors",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_OrderProducts_ProductOptions_ProductOptionId",
                        column: x => x.ProductOptionId,
                        principalTable: "ProductOptions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_OrderProducts_Fields_fieldId",
                        column: x => x.fieldId,
                        principalTable: "Fields",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OptionColors_ProductOptionId",
                table: "OptionColors",
                column: "ProductOptionId");

            migrationBuilder.CreateIndex(
                name: "IX_OrderProducts_OptionColorId",
                table: "OrderProducts",
                column: "OptionColorId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OrderProducts_ProductOptionId",
                table: "OrderProducts",
                column: "ProductOptionId");

            migrationBuilder.CreateIndex(
                name: "IX_OrderProducts_fieldId",
                table: "OrderProducts",
                column: "fieldId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductOptions_FieldId",
