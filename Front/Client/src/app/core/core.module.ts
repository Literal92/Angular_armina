...
//import { HeaderComponent } from "./component/header/public/header.component";
import { ApiConfigService } from "./services/api-config.service";
import { APP_CONFIG, AppConfig } from "./services/app.config";
import { AuthInterceptor } from "./services/auth.interceptor";
import { XsrfInterceptor } from "./services/xsrf.interceptor";
import { HelperError } from './services/helper.error.service';

@NgModule({
  imports: [CommonModule, RouterModule],
  exports: [
    // components that are used in app.component.ts will be listed here.
    //AdminHeaderComponent, HeaderComponent
  ],
  declarations: [
    // components that are used in app.component.ts will be listed here.
    //AdminHeaderComponent, HeaderComponent
