...
@Directive({
  selector: "[isVisibleForUserClaim]"
})
export class IsVisibleForUserClaimDirective implements OnInit, OnDestroy {

  private subscription: Subscription | null = null;

  // @Input() isVisibleForClaim: ShemaUrl[] | null = null;
  @Input() isVisibleForUserClaim: string | null = null;
  ...
  private changeVisibility(status: boolean) {
    ...
    const isInClaim = !isVisibleForClaim ? true : this.authService.isAuthUserInUserClaim/*isAuthUserInRoles*/(isVisibleForClaim);
